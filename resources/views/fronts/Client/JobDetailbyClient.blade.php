            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href={{route('Client.Home')}}><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Back to Jobs</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card shadow border-0">
                    ...
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="pt-3 text-end">
                            ...
                            <a href={{route('Job.ApplyJob')}} onclick="applyjob({{$job->id}})" class="btn btn-primary">Apply</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow border-0">
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                <li>Published on: <span>{{$job->created_at->diffForHumans()}}</span></li>
