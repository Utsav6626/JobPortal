...
{{--                        <img src="{{asset('profile_pic/thumb/'.$user->image)}}" alt="avatar"  class="rounded-circle img-fluid" style="width: 150px;">--}}
                        ...
                        {{--<div class="d-flex justify-content-center mb-2">--}}
                            {{--<form method="post" action="{{route('account.Profile_Pic')}}" enctype="multipart/form-data">--}}
                                {{--@csrf--}}
                                {{--<div class="mb-3">--}}
