	...
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<a class="btn btn-outline-primary me-2" href={{route('Recruiter.Login')}} type="submit">Recruiter Login</a>
				<a class="btn btn-primary" href={{route('Client.Login')}} type="submit">Login</a>
			</div>
		</div>
	</nav>
</header>
